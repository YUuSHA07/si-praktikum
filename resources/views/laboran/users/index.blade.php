<x-app-layout>
    ...
    <div class="py-0">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            {{-- Alert Notifikasi --}}
            @if(session('success'))
                <div class="p-4 bg-emerald-50 border-l-4 border-emerald-500 text-emerald-700 text-sm font-bold rounded shadow-sm flex items-center animate-fade-in">
            ...
            @if(session('error'))
                <div class="p-4 bg-red-50 border-l-4 border-red-500 text-red-700 text-sm font-bold rounded shadow-sm flex items-center">
